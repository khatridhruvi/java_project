			...
			<div class="container-fluid px-lg-5">
				...
				<nav class="py-4">
					...
					<ul class="menu mt-2">
						...
						<li>
							<!-- First Tier Drop Down --> <label for="drop-2" class="toggle">Registration
								<span class="fa fa-angle-down" aria-hidden="true"></span>
						</label> <span class="fa fa-angle-down" aria-hidden="true"></span> </label> <a
							href="#">Registration <span class="fa fa-angle-down"
						...
						<li>
							<!-- First Tier Drop Down --> <label for="drop-2" class="toggle">Login
								<span class="fa fa-angle-down" aria-hidden="true"></span>
	...
	<section class="ab-info-main py-5">
		<div class="container py-3">
			<h3 class="tittle text-center">
				<span class="sub-tittle"></span> Seller Login
			</h3>
			...
			<div class="row contact-main-info mt-5">
				<div class="col-md-12 contact-right-content">
					<form action="SellerController" method="post">
						...
						<div class="read mt-3 text-center">
