...
<head>
<title>Bootstrap Responsive Web Template | Home :: W3layouts</title>
<!-- Meta tag Keywords -->
		...
		<header class="header">
			<div class="container-fluid px-lg-5">
				...
				<nav class="py-4">
					<div id="logo">
						<h1>
							<a href="customer-index.jsp"><span class="fa fa-bold"
					...
					<ul class="menu mt-2">
						...
						<li>
							<!-- First Tier Drop Down --> <label for="drop-2" class="toggle">Product
								<span class="fa fa-angle-down" aria-hidden="true"></span>
						</label> <a href="#">Product <span class="fa fa-angle-down"
								aria-hidden="true"></span></a> <input type="checkbox" id="drop-2" />
							<ul>
								<li><a href="customer-add-wishlist.jsp">Add to wish list</a></li>
								<li><a href="customer-add-cart.jsp">Add to cart</a></li>
							</ul>
						</li>
						...
						</label> <a href="#"><%=c1.getName()%> <span class="fa fa-angle-down"
								aria-hidden="true"></span></a> <input type="checkbox" id="drop-2" />
							<ul>
